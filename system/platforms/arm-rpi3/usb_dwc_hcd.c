 ...
 *
 *  - AHBコンフィギュレーションレジスタには、DWCハードウェアからのすべての
 *    割り込みを有効/無効にするマスクビットがある。
 *  - "Core" 割り込みと "Core" 割り込みマスクレジスタは、トップレベルの
