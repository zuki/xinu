...
struct bcm2835_timer_regs {
    unsigned int CS;  /** システムタイマー コントロール/ステータス */
    unsigned int CLO; /** システムタイマー カウンター下位32ビット */
    unsigned int CHI; /** システムタイマー カウンター上位32ビット */
    unsigned int C0;  /** システムタイマー コンペア 0.  使用不可; GPUで使用済み  */
    unsigned int C1;  /** システムタイマー コンペア 1 */
    unsigned int C2;  /** システムタイマー コンペア 2.  使用不可; GPUで使用済み  */
    unsigned int C3;  /** システムタイマー コンペア 3 */
};
