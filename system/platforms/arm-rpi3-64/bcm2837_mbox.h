...
/* メールボックス関数 */
void bcm2837_mailbox_write(uint32_t, uint32_t);
uint32_t bcm2837_mailbox_read(uint32_t);
...
static volatile uint64_t *const mailbox_regs = (volatile uint64_t*)MAILBOX_REGS_BASE;
